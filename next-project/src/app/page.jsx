const HomePage = async () => {
  return (
    <div className="text-white border-sky-200 w-3/6">
      <h1 className="text-4xl p-5">¡Bienvenido a mi proyecto con Next.js!</h1>
      <hr />
      <div className=" text-center">
        <p className="text-center p-2 "></p>
        Proyecto con Next.js y la API Reqres.inEn esta iniciativa, he puesto en
